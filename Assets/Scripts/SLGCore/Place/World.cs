...
public class World : Place
{
    ...
    //    List<Province> possibleProvinces = provinces.Where(x => x.TerrainType == TerrainType.Land).ToList();
    ...
    //{
    //    List<Province> provinces = ChildPlaces.Cast<Province>().ToList();
    //    List<Province> possibleProvinces = provinces.Where(x => x.TerrainType == TerrainType.Land && x.ChildPlaces.Count == 0).ToList();
